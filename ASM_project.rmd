...
ts.plot(serie, tl1, tu1, pr1, lty = c(1, 2, 2, 1), col = c(1, 4, 4, 2),
        xlim = c(2017, 2020), type = "o",
        main = paste("Model ARIMA(6,1,1)(0,1,1)12"))
abline(v = (2017:2020), lty = 3, col = 4)

# Visualize predictions for Model 2
ts.plot(serie, tl2, tu2, pr2, lty = c(1, 2, 2, 1), col = c(1, 4, 4, 2),
        xlim = c(2017, 2020), type = "o",
        main = paste("Model ARIMA(2,1,1)(0,1,1)12"))
abline(v = (2017:2020), lty = 3, col = 4)

# Visualize predictions for Model 3
ts.plot(serie, tl3, tu3, pr3, lty = c(1, 2, 2, 1), col = c(1, 4, 4, 2),
        xlim = c(2017, 2020), type = "o",
        main = paste("Model ARIMA(0,1,1)(0,1,1)12"))
abline(v = (2017:2020), lty = 3, col = 4)
